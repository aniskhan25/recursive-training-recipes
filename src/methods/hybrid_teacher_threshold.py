...
def run_hybrid(
    ...
    for epoch in progress(range(epochs), enabled=use_progress, desc="hybrid epochs"):
        ...
        batch_accept = float(accepted_total) / float(accepted_count) if accepted_count else 0.0
